    ...
    <>
      ...
      <section className="trust-bar" aria-label="Why clients trust us">
        {[
          ...
          { text: 'Deep Expertise Across 30+ Dallas Neighborhoods', icon: trustIcons[1] },
          { text: 'Five-Star Client Reviews Across Google and Zillow', icon: trustIcons[2] },
          { text: 'Hundreds of Successful Dallas Transactions Closed', icon: trustIcons[3] },
        ].map((item, i) => (
          <div
          ...
          {[
            {
              ...
              desc: 'Navigate the competitive Dallas housing market with a Compass agent who knows every neighborhood from Lakewood to Lake Highlands. Alex Prins delivers off-market opportunities and winning offer strategies that get you the keys.',
            },
            {
              title: 'Home Selling Strategy',
              desc: 'Sell your Dallas home faster and for top dollar with Compass technology, professional staging, and pricing strategies built on hyperlocal DFW market data. Every listing gets the full white-glove treatment.',
            },
            {
              title: 'Luxury Properties',
              desc: 'From Preston Hollow estates to Uptown high-rises, Alex Prins brings discreet, high-touch service to Dallas luxury real estate. Compass private exclusives give sellers and buyers a distinct edge.',
            },
            {
              title: 'Relocation Services',
              desc: 'Moving to Dallas for work or lifestyle? Get expert guidance on neighborhoods, schools, commute times, and the nuances that only a local agent understands. Your smooth transition starts here.',
            },
            {
              title: 'Investment Properties',
              desc: 'Dallas is one of the hottest real estate investment markets in the country. Alex identifies cash-flow properties, emerging neighborhoods, and value-add opportunities across the Metroplex.',
            },
            {
              title: 'Market Analysis',
              desc: 'Get a data-driven comparative market analysis powered by Compass insights and deep Dallas expertise. Know exactly what your home is worth before you make your next move.',
            },
          ].map((service, i) => (
            <div
      ...
      <section className="section about" aria-label="About us">
        <div className="about-grid">
          ...
          <div className="about-content" data-animate data-delay="2">
            ...
            <p className="about-text">{'Alex Prins Real Estate Agent - Compass brings a sharp, client-first approach to buying and selling homes across Dallas, TX. With the full power of Compass technology and a genuine passion for connecting people with the right property, Alex delivers results that speak for themselves. Whether you are searching for your forever home in University Park or listing a condo in the Arts District, you are working with someone who treats your goals like their own.'}</p>
